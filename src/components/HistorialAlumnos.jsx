...
import {
                        ...
                        <tr key={e.id_alumno} className="hover:bg-slate-200">
                          ...
                          <td>
                            <div className="flex flex-col">
                              ...
                              <button
                                className={e.activo==0? false: "visible btn bg-blue-600 text-white hover:bg-blue-300  hover:text-black"} 
                                id={e.id_alumno}
                              >
                                generar QR
                              </button>
  ...
  export default HistorialAlumnos;
