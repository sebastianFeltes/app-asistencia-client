			...
			<div className="hero-content text-center w-full">
				<div className="border-4 border-black w-full rounded-3xl">
					<div className=" border-black w-full ">
						<h2 className="text-black text-3xl font-bold justify-center">ALTA CURSO</h2>
						...
						>
							...
							<div className="grid grid-cols-2 gap-4 m-2 ">
								...
								<div id="contenedor1" className=" border-black flex flex-col m-2 ">
									...
									<label className="label">
										<span className="label-text text-black">NOMBRE DEL DOCENTE:</span>
									</label>
									...
									<div className="flex m-0">
										...
										>
											{dataDias
												? dataDias.map((e) => {
														return (
															<option value={e.id_dia + " " + e.nombre} key={e.id_dia}>
																{e.nombre}
															</option>
														);
												  })
								...
								<div className=" border-black flex flex-col m-2 ">
									<label className="label">
										<span className="label-text text-black">HORARIO DE INICIO:</span>
									</label>
									<div className=" flex">
										<label className="label ">
									...
									<label className="label">
										<span className="label-text text-black">HORARIO FINAL:</span>
									</label>
									<div className=" flex">
										<label className="label ">
											<p className="label-text ms-2 text-black">hora:</p>
									...
									<div className=" flex">
										...
										<label className="label">
											<span className="label-text ms-14 text-black">FECHA DE FINALIZACION:</span>
										</label>
									</div>
									<div className="form-control flex flex-row">
										<input
