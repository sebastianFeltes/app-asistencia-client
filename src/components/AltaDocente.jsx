...
export default function AltaDocente() {
	...
	async function post(e) {
		...
		const data = {
			...
			apellido: apellidoDoc.toUpperCase(),
				...
				<div className="hero-content text-center  border-4 m-2 border-black rounded-3xl w-full ">
					<div className="w-full ">
						...
						>
							<div
								id="contenedor1"
								className="flex flex-col justify-center w-1/2 p-0 text-center items-center "
							>
								<span>
									<div className=" p-0   flex flex-row w-full">
										<div
											id=""
											className="from-control mb-0 mt-auto mr-2  flex flex-col flex-grow-0 "
										>
											...
											<select
												...
												className="m-0 b w-full select text-black bg-transparent mr-auto rounded-full border-black "
											>
												<option>Tipo </option>
												<option>DU</option>
												<option>LC</option>
								...
								<label className="label w-3/4 max-w-xs">
									<span className="label-text  text-black">FECHA DE NACIMIENTO</span>
								</label>
								<input
									id="fechaNac"
									type="date"
								...
								<label className="label">
									<span className="label-text text-black">
										CREA TU CONTRASEÑA
										<span className="label-text text-xs text-black ml-10 ">
											*Minimo 8 caracteres
										</span>
									</span>
								</label>
								...
								<label className="label">
									<span className="label-text text-black">
										...
										<span className="label-text text-xs text-black ml-5 ">
											*Minimo 8 caracteres
										</span>
									</span>
								</label>
							...
							<div
								id="contenedor2"
								className="  flex flex-col  justify-center w-1/2 min-h-full text-center items-center "
							>
								<label className="label w-3/4 max-w-xs">
								...
								<div className="flex flex-row ">
									...
									<div className="flex flex-col justify-start">
										<label className="label">
											<span className="label-text  text-black">
												TELEFONO<span>*sin guiones ni puntos</span>
											</span>
										</label>
										<input
											id="tele"
								...
								<div className="flex flex-row">
									...
									<div className="flex flex-col justify-start">
										<label className="label">
											<span className="label-text  text-black ">
												TEL EXTRA <span>*sin guiones ni puntos</span>
											</span>
										</label>
										<input
											id="telex"
							...
							<div className="h-full flex flex-row mt-4  w-full justify-evenly  text-center items-end">
								<button
									type="submit"
									className="btn bg-blue-600 rounded-full w-48 border-none  text-white"
								>
									ACEPTAR
								</button>
								...
								<button
									type="reset"
									className="btn bg-blue-600 w-48 rounded-full border-none text-white"
								>
									CANCELAR
								</button>
							</div>
