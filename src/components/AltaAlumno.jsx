...
import postAltaAlumno, { getAltaAlumno, postAltaAlumnosModificado } from "../services/altaAlumnos.services";
			...
			<div className="hero-content text-center m-4 border-4 border-black w-screen rounded-3xl ">
				<div className=" w-10/12">
					<div className=" border-black w- ">
						<h2 className="text-black text-4xl font-bold mb-8 justify-center">ALTA ALUMNO</h2>
						...
						<form onSubmit={(e) => post(e)}>
							...
							<div className="grid grid-cols-2 w-full gap-4 m-6 ">
								...
								<div id="contenedor1" className=" border-black flex flex-col m-2 w-full  ">
									...
									<input
										id="apellidoAlumno"
										defaultValue={alumnoExistente ? alumnoExistente.apellido : ""}
										type="text"
									...
									<input
										...
										defaultValue={
											alumnoExistente
												? alumnoExistente.fecha_nac.split("/").reverse().join("-")
												: ""
										}
										type="date"
									...
									<input
										id="localidadAlumno"
										defaultValue={alumnoExistente ? alumnoExistente.localidad : ""}
										type="text"
									...
									<input
										id="direccionAlumno"
										defaultValue={alumnoExistente ? alumnoExistente.direccion : ""}
										type="text"
								...
								<div className=" border-black flex flex-col m-2 w-full ">
									<div className=" flex">
										<label className="label ">
											<p className="label-text ms-1 text-black">
												TEL CARACT:{" "}
												<span className="label-text text-xs text-black ">*sin 0</span>{" "}
											</p>
										</label>
										<label className="label">
									...
									<div className="form-control flex flex-row">
										<input
											...
											defaultValue={alumnoExistente ? alumnoExistente.car_telefono : ""}
											type="number"
											placeholder="Ej: 221"
									...
									<div className="form-control flex flex-row">
										<input
											id="telCaracterExtra"
											defaultValue={alumnoExistente ? alumnoExistente.car_tel_extra : ""}
											type="number"
											placeholder="Ej: 221"
										...
										<input
											id="telExtra"
											defaultValue={alumnoExistente ? alumnoExistente.telefono_extra : ""}
											type="number"
											placeholder="Ingrese tel"
									...
									<input
										id="nroLegajoAlumno"
										defaultValue={alumnoExistente ? alumnoExistente.nro_legajo : ""}
										type="number"
									...
									<div className="m-0 p-0">
											...
											>
												...
												{!data
													...
													: data.map((e) => (
															<option
																key={e.id_curso}
																value={e.id_curso + "-" + e.nombre.toUpperCase()}
															>
										...
										<div className="form-control flex flex-row ">
											<label className="label">
												<span className="label-text text-black">DOCUMENTACIÓN:</span>
											</label>
										</div>
										...
										<div className="flex  border  border-black w-80 rounded-full h-12">
											<label className="label cursor-pointer ml-3">
												...
												<input
													defaultValue={alumnoExistente ? alumnoExistente.fotoc_dni : ""}
													id="docDni"
													type="checkbox"
											...
											<label className="label cursor-pointer">
												...
												<input
													defaultValue={alumnoExistente ? alumnoExistente.planilla_ins : ""}
													id="docPlanilla"
													type="checkbox"
													className="checkbox  border-black m-2 "
												/>
